...
# path='C:/myworkspace/MyPython/project1906/Naver_movie_omitted_json/'
...
######코드 실행문 시작
myfile='누락되었던 영화 링크모음.csv'
 
mylink=pd.read_csv(myfile,encoding='cp949')
...
# for title,onelink in result[:2]:
    ...
    mypath='C:/myworkspace/MyPython/project1906/Naver_ommitted_reply_list/'
