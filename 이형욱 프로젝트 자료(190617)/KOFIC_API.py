...
class Kofic:
    ...
    def toJson(self,result):
        with open('C:/myworkspace/MyPython/project1906/KOFIC_json/{}-{}movielist{}.json'.format(self.openStartDt,self.openEndDt,self.curPage), 'w', encoding='utf-8') as file :
...
for idx in range(111):
    ...
    imsi=kofic1.get_movie_list('C:/myworkspace/MyPython/project1906/KOFIC_json/2010-2019movielist'+str(idx+1)+'.json') 
    for onename in imsi:
        mylist.append(onename)
print(mylist)
# print(len(mylist))
# imsi=kofic1.get_movie_list('C:/myworkspace/MyPython/project1906/KOFIC_json/2010-2019movielist1.json')
# print(imsi)
##################클래스마무리###############
