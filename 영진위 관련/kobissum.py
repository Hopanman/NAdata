...
output_path = r'C:\Users\DELL\eclipse-workspace\HomeTraining\Home\result.csv' # 하나로 합칠 파일명

first_file = True
for input_file in glob.glob(os.path.join(input_path, 'kobisapi_*')): # csv파일들과 주소를 결합하여 파일을 불러온다
